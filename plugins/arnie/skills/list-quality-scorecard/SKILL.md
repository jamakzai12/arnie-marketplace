...
description: Use the Arnie CLI to grade a prospect/lead table before outreach — duplicates, missing fields, risky emails/domains, title/ICP fit — and gate the send with concrete fixes.
---
