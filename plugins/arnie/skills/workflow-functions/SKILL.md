...
description: Use the Arnie CLI before reusable row work — saved-function lookup, call binding, installed-column reconciliation, conflicts, roots, and saving. Function-first beats a hand-built column.
---
...
| Rate limits | Preserve existing values; change only after actual table cells show provider rate-limit failures (see **arnie-ingredients**) |
