---
name: ai-columns
description: Use the Arnie CLI for copilot_workflow_workbench ai_generated columns — extract, normalize, classify, score, summarize, or write from row evidence. AI reasons over evidence already in the table; it does not fetch missing facts.
---
