...
description: Use the Arnie CLI to declare the Outcome-matching contract — build one final row-level outcome table with a match tag, or tag a campaign's identity so results match back to campaign rows.
---
