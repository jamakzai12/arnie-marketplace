...
description: Use for copilot_workflow_workbench formula or condition columns over remote MCP — {{column_id}} syntax, the safe evaluator rules, conditional gates, and waterfall final-value formulas.
---
