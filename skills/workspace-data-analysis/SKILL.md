...
description: Use over remote MCP to analyze existing workspace/table data, past campaign results, cross-table performance, or outcome metrics before doing new work — answer from workspace truth first.
---
