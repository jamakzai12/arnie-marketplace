---
name: build-tam
description: Use to build or complete a durable TAM, large ICP company list, or account universe over remote MCP — market counts, paginated coverage, qualify companies before contacts.
---
