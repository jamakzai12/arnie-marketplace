...
description: Use before copilot_workflow_workbench(action:"query") over remote MCP — read-only SQL over table/workspace snapshots, row/cell status, provider errors, JSON probes, and SQL repair.
---
