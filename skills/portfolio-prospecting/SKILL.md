...
description: Use to source companies from a named fund, VC, investor, accelerator, association, membership, or public portfolio over remote MCP — the official source defines membership; qualify companies before contacts.
---
