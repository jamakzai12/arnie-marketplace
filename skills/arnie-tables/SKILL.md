---
name: arnie-tables
description: Use when Claude Code needs to read, query, sample, expand, reconcile, or reason about Arnie workflow tables through remote MCP — row samples, table SQL, expand_array child tables, column config, and safe reruns.
---
