...
description: Use to tune, lock, and scale truthful per-row outbound copy over remote MCP — enrich first, tune on a tiny sample, turn edits into rules, lock the prompt, then scale behind cost approval.
---
